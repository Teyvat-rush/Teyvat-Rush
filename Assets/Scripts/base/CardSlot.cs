...
public class CardSlot : MonoBehaviour
{
    ...
    public List<GameObject> attainedCards = new List<GameObject>();//将拥有的角色卡导入///////////////读取关卡进度，改变按钮状态
    public List<GameObject> selectedCards = new List<GameObject>();//选中的角色卡
    public List<int> selectedCardsIndex_2 = new List<int>();
    ...
    void Start()
    {
        ...
        maxCardNumHere = GameManager.instance.GetComponent<GameManager>().maxCardNum;//////////////////////////////////读取关卡进度，获取最大卡槽数
